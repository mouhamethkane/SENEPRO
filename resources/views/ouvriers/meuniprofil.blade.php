...
@section("content")
    <div class="row">
            ...
            <h3>
                <div class="row">
                    <div class="col bg-white rounded-circle text-dark">
                        <center>AHMADOU GUEYE</center>
                        <h5 class="text-center">MEUNISIER BOIS</h5>
         ...
         <div class="row">
            <div class="col-6">
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus nesciunt molestias, 
                    ...
                    <div class="col-6">
                        <center><img src="{{asset('/image/ms0.jpg')}}" class="rounded-circle bg-dark" width="50%" height="90%"></center>
        ...
        <div class="container bg-dark text-white rounded-pill">
            <h1>
                <center><strong>Voici les realisations de Ahmadou Gueye</strong> </center>
            </h1>
        </div>
            <div class="container bg-white">
                ...
                <div class="col-sm-4 my-4">
                    <div class="card">
                    <div class="card-body">
                    <img src="{{asset('/image/ms1.jpg')}}" class="rounded bg-dark" width="370" height="250"alt="mass"><br><br>
                ...
                <div class="col-sm-4 my-4">
                    <div class="card">
                    <div class="card-body">
                    <img src="{{asset('/image/ms2.jpg')}}" class="rounded bg-dark" width="370" height="250"alt="mass"><br><br>
                ...
                <div class="col-sm-4 my-4">
                    <div class="card">
                    <div class="card-body">
                    <img src="{{asset('/image/ms3.jpg')}}" class="rounded bg-dark" width="370" height="250"alt="mass"><br><br>
                    <h5 class="card-title">Coiffeuse</h5>
                        <a href="/coiffeurprofil" class=""></a>
                    </div>
                    </div>
                </div>
    ...
    <div class="container bg-white">
                ...
                <div class="col-sm-4 my-4">
                    <div class="card">
                    <div class="card-body">
                    <img src="{{asset('/image/ms4.jpg')}}" class="rounded bg-dark" width="370" height="250"alt="mass"><br><br>
                    <h5 class="card-title">Coiffeuse</h5>
                        <a href="/coiffeurprofil" class=""></a>
                    </div>
                    </div>
                ...
                <div class="col-sm-4 my-4">
                    <div class="card">
                    <div class="card-body">
                    <img src="{{asset('/image/ms5.jpg')}}" class="rounded bg-dark" width="370" height="250"alt="mass"><br><br>
                ...
                <div class="col-sm-4 my-4">
                    <div class="card">
                    <div class="card-body">
                    <img src="{{asset('/image/ms6.jpg')}}" class="rounded bg-dark" width="370" height="250"alt="mass"><br><br>
                    <h5 class="card-title">Chambre à couché</h5>
                        <a href="/coiffeurprofil" class=""></a>
                    </div>
                    </div>
                </div>
