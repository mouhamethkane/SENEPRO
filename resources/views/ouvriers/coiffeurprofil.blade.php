...
@section("content")
    <div class="row">
            ...
            <h3>
                <div class="row">
                    <div class="col bg-white rounded-circle text-dark">
                        <center>OUMOU CISSE</center>
                        <h5 class="text-center">COIFFEUSE</h5>
         ...
         <div class="row">
            <div class="col-6">
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus nesciunt molestias, 
                    ...
                    <div class="col-6">
                        <center><img src="{{asset('/image/coiffeuse3.jpg')}}" class="rounded-circle bg-dark" width="50%" height="70%"></center>
        ...
        <div class="container bg-dark text-white rounded-pill">
            <h1>
                <center><strong>Voici les realisations de Oumou Cisse</strong> </center>
            </h1>
        </div>
