...
@section("content")
    <div class="row">
            ...
            <h3>
                <div class="row">
                    <div class="col bg-white rounded-circle text-dark">
                        <center>vous etes dans la categorie des electriciens</center><br>
        ...
        <div class="container bg-dark text-white rounded-pill">
            <h1>
                <center><strong>Voici la liste des electriciens disponiblesa dans les differentes region</strong> </center>
            </h1>
            </div>
            <div class="container bg-white">
                ...
                <div class="col-sm-4 my-4">
                    ...
                    <img src="{{asset('/image/electricien1.jpg')}}" class="rounded bg-dark" width="370" height="200"alt="mass"><br><br>
                        ...
                        <a href="/electricienprofil" class="btn btn-primary">MOUHAMETH KANE</a>
                    </div>
                    </div>
                </div>
                <div class="col-sm-4 my-4">
                    ...
                    <img src="{{asset('/image/electricien2.jpg')}}" class="rounded bg-dark" width="370" height="200"alt="mass"><br><br>
                        ...
                        <a href="/electricienprofil" class="btn btn-primary">PAPA ABDOU BITEYE</a>
                    </div>
                    </div>
                </div>
                <div class="col-sm-4 my-4">
                    ...
                    <h5 class="card-title">Information</h5>
                        ...
                        <a href="/electricienprofil" class="btn btn-primary">MASSEYE GNING</a>
                    </div>
                    </div>
                </div>
                </div>
    ...
    <div class="container bg-white">
                ...
                <div class="col-sm-4 my-4">
                    ...
                    <h5 class="card-title">Information</h5>
                        ...
                        <a href="/electricienprofil" class="btn btn-primary">SERIGNE SALIOU FALL</a>
                    </div>
                    </div>
                </div>
                <div class="col-sm-4 my-4">
