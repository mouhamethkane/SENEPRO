            ...
            <div class="container bg-white">
                ...
                <div class="col-sm-4 my-4">
                    ...
                    <img src="{{asset('/image/cuisine1.jpg')}}" class="rounded bg-dark" width="370" height="200"alt="mass"><br><br>
                        ...
                        <a href="/chef_cousinerprofil" class="btn btn-primary">MOUHAMETH KANE</a>
                    </div>
                    </div>
                </div>
                <div class="col-sm-4 my-4">
                    ...
                    <img src="{{asset('/image/cuisine2.jpg')}}" class="rounded bg-dark" width="370" height="200"alt="mass"><br><br>
                        ...
                        <a href="/chef_cousinerprofil" class="btn btn-primary">PAPA ABDOU BITEYE</a>
                    </div>
                    </div>
                </div>
                <div class="col-sm-4 my-4">
                    ...
                    <h5 class="card-title">Information</h5>
                        ...
                        <a href="/chef_cousinerprofil" class="btn btn-primary">MASSEYE GNING</a>
                    </div>
                    </div>
                </div>
                </div>
    ...
    <div class="container bg-white">
                ...
                <div class="col-sm-4 my-4">
                    ...
                    <h5 class="card-title">Information</h5>
                        ...
                        <a href="/chef_cousinerprofil" class="btn btn-primary">SERIGNE SALIOU FALL</a>
                    </div>
                    </div>
                </div>
                <div class="col-sm-4 my-4">
