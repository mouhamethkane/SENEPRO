...
@section("content")
    <div class="row">
            ...
            <h3>
                <div class="row">
                    <div class="col bg-white rounded-circle text-dark">
                        <center>MOUSSA DIALLO</center>
                        <h5 class="text-center">CULTIVATEUR</h5>
         ...
         <div class="row">
            <div class="col-6">
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus nesciunt molestias, 
                    ...
                    <div class="col-6">
                        <center><img src="{{asset('/image/a0.jpg')}}" class="rounded-circle bg-dark" width="50%" height="90%"></center>
        ...
        <div class="container bg-dark text-white rounded-pill">
            <h1>
                <center><strong>Voici les realisations de Moussa Diallo</strong> </center>
            </h1>
        </div>
            <div class="container bg-white">
                ...
                <div class="col-sm-4 my-4">
                    <div class="card">
                    <div class="card-body">
                    <img src="{{asset('/image/a1.jpg')}}" class="rounded bg-dark" width="370" height="250"alt="mass"><br><br>
                        <h5 class="card-title">Carrotte</h5>
                ...
                <div class="col-sm-4 my-4">
                    <div class="card">
                    <div class="card-body">
                    <img src="{{asset('/image/a2.jpg')}}" class="rounded bg-dark" width="370" height="250"alt="mass"><br><br>
                ...
                <div class="col-sm-4 my-4">
                    <div class="card">
                    <div class="card-body">
                    <img src="{{asset('/image/a3.jpg')}}" class="rounded bg-dark" width="370" height="250"alt="mass"><br><br>
    ...
    <div class="container bg-white">
                ...
                <div class="col-sm-4 my-4">
                    <div class="card">
                    <div class="card-body">
                    <img src="{{asset('/image/a4.jpg')}}" class="rounded bg-dark" width="370" height="250"alt="mass"><br><br>
                    <h5 class="card-title">Arachide</h5>
                        <a href="/coiffeurprofil" class=""></a>
                    </div>
                    </div>
                </div>
                <div class="col-sm-4 my-4">
                    <div class="card">
                    <div class="card-body">
                    <img src="{{asset('/image/a5.jpg')}}" class="rounded bg-dark" width="370" height="250"alt="mass"><br><br>
                    <h5 class="card-title">Sorgou</h5>
                        <a href="/coiffeurprofil" class=""></a>
                    </div>
                    </div>
                </div>
                <div class="col-sm-4 my-4">
                    <div class="card">
                    <div class="card-body">
                    <img src="{{asset('/image/a6.jpg')}}" class="rounded bg-dark" width="370" height="250"alt="mass"><br><br>
                    <h5 class="card-title">Mil</h5>
                        <a href="/coiffeurprofil" class=""></a>
                    </div>
                    </div>
                </div>
