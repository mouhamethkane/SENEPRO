            ...
            <div class="container bg-white">
                ...
                <div class="col-sm-4 my-4">
                    ...
                    <img src="{{asset('/image/maquilleuse1.jpg')}}" class="rounded bg-dark" width="370" height="200"alt="mass"><br><br>
                        ...
                        <a href="/maquiprofil" class="btn btn-primary">OUMOU CISSE</a>
                    </div>
                    </div>
                </div>
                <div class="col-sm-4 my-4">
                    ...
                    <img src="{{asset('/image/maquilleuse2.webp')}}" class="rounded bg-dark" width="370" height="200"alt="mass"><br><br>
                        ...
                        <a href="/maquiprofil" class="btn btn-primary">AMY GUEYE</a>
                    </div>
                    </div>
                </div>
                <div class="col-sm-4 my-4">
                    ...
                    <h5 class="card-title">Information</h5>
                        ...
                        <a href="/maquiprofil" class="btn btn-primary">NDAYE GUEYE</a>
                    </div>
                    </div>
                </div>
                </div>
    ...
    <div class="container bg-white">
                ...
                <div class="col-sm-4 my-4">
                    ...
                    <h5 class="card-title">Information</h5>
                        ...
                        <a href="/maquiprofil" class="btn btn-primary">SOKHNA NDOUR</a>
                    </div>
                    </div>
                </div>
                <div class="col-sm-4 my-4">
                    ...
                    <h5 class="card-title">Information</h5>
                        ...
                        <a href="/maquiprofil" class="btn btn-primary">AWA NDIAYE</a>
                    </div>
                    </div>
                </div>
                <div class="col-sm-4 my-4">
                    ...
                    <h5 class="card-title">Information</h5>
                        ...
                        <a href="/maquiprofil" class="btn btn-primary">AMY COLLE NDIAYE</a>
                    </div>
                    </div>
                </div>
                </div>
...
<div class="container bg-white">
                ...
                <div class="col-sm-4 my-4">
                    ...
                    <h5 class="card-title">Information</h5>
                        ...
                        <a href="/maquiprofil" class="btn btn-primary">ANTA FALL</a>
                    </div>
                    </div>
                </div>
                <div class="col-sm-4 my-4">
                    ...
                    <h5 class="card-title">Information</h5>
                        ...
                        <a href="/maquiprofil" class="btn btn-primary">NDEYE ASTOU DIOP</a>
                    </div>
                    </div>
                </div>
                <div class="col-sm-4 my-4">
                    ...
                    <h5 class="card-title">Information</h5>
                        ...
                        <a href="/maquiprofil" class="btn btn-primary">DIAYNABA THIAM</a>
                    </div>
                    </div>
                </div>
                </div>                
